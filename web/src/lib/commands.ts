...
export const PLACES: Command[] = [
	...
	{ id: 'go-highlights', label: 'Highlights', kind: 'Go', href: '/highlights', keywords: 'marked quotes notes' },
	...
	{ id: 'go-feed', label: 'Feed', kind: 'Go', href: '/feed', keywords: 'following new updates' },
